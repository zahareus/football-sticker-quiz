...
function startEasyGame() { selectedDifficulty = 1; console.log('Starting Easy game without login.'); if(landingPageElement) landingPageElement.style.display = 'none'; if(introTextElement) introTextElement.style.display = 'none'; startGame(); }
